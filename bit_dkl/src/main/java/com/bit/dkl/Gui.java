...
public class Gui {
    public static void runGui(LocalPredictor predictor, String os) throws IOException {
        ...
        JLabel wNameLabel = new JLabel("笼状化合物合成预测");
        wNameLabel.setBounds(796, 10, 330, 25);
        Font wfont = new Font("SansSerif", Font.BOLD, 24);

        wNameLabel.setFont(wfont);
        panel.add(wNameLabel);

        JLabel weNameLabel = new JLabel("Caged Compound Synthesis Predictor");
        weNameLabel.setBounds(796, 40, 330, 25);
        ...
        loginButton.setBackground(new Color(174,47,0));
        ...
        int xLocation = os.equals("--win") ? 1114 : 1094;
